...
//---------------------------
    ...
    private static final ArrayList<Personel> personelListesi
            = new ArrayList<Personel>(Arrays.asList(
                    ...
                    new Personel("1299", "Metin 2", 22, new BigDecimal("1500.00")),
                    new Personel("1326", "Salih Memişoğlu", 20, new BigDecimal("1800.00")),
                    new Personel("632", "Cumali Yemişoğlu", 23, new BigDecimal("1300.00")))
            );
